...
import {listOfComponents} from './try-require'
...
export const getComponentsList = () => listOfComponents

export const getSuiStudioConfig = () => {
  const { config = {} } = require(`${__BASE_DIR__}/package.json`) // TODO ¿use codegen?
